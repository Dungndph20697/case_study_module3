                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <span
                              class="badge bg-warning text-dark badge-custom"
                              >256 GB</span
                            >
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="text-success fw-bold">34.990.000 ₫</td>
                          <td>
                            <span class="badge bg-warning badge-custom">8</span>
                          </td>
                          <td>
                            <span class="badge bg-success badge-custom"
                              >Còn hàng</span
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            >
                              <i
                                class="fas fa-mobile-alt fa-2x text-success"
                              ></i>
                            </div>
                          </td>
                          ...
                          <td class="text-success fw-bold">26.990.000 ₫</td>
                          <td>
                            <span class="badge bg-danger badge-custom">0</span>
                          </td>
                          <td>
