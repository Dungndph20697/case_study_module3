        ...
        <div class="col-md-9 col-lg-10 main-content p-0">
            ...
            <div class="p-4">
                ...
                <div class="mb-5 section-divider">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/admin/hang?action=update" method="post">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/hang"
    ...
    <div class="modal fade" id="addModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="${pageContext.request.contextPath}/admin/hang?action=create" method="post">
                    <!-- ẩn ID vì thêm mới -->
                    ...
                    <a href="${pageContext.request.contextPath}/admin/hang" class="btn btn-secondary">
