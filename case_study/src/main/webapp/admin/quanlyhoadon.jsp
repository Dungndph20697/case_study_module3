                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          <td><span class="badge bg-primary">#HD001</span></td>
                          <td class="fw-bold">Phạm Văn Đức</td>
                          <td>15/11/2024</td>
                          <td class="text-success fw-bold">29.990.000 ₫</td>
                          <td>
                            <span
                              class="badge bg-success badge-custom invoice-status"
                              >Đã thanh toán</span
                            >
                          </td>
                          <td>Lê Minh Cường</td>
                        ...
                        <tr>
                          <td><span class="badge bg-primary">#HD002</span></td>
                          <td class="fw-bold">Hoàng Thị Lan</td>
                          <td>14/11/2024</td>
                          <td class="text-success fw-bold">22.990.000 ₫</td>
                          <td>
                            <span
                              class="badge bg-warning badge-custom invoice-status"
                        ...
                        <tr>
                          <td><span class="badge bg-primary">#HD003</span></td>
                          <td class="fw-bold">Vũ Minh Tuấn</td>
                          <td>13/11/2024</td>
                          <td class="text-success fw-bold">45.990.000 ₫</td>
                          <td>
                            <span
                              class="badge bg-danger badge-custom invoice-status"
                              >Đã hủy</span
                            >
                          </td>
                          <td>Trần Thị Bình</td>
