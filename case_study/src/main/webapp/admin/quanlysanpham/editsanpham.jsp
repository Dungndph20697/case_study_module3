        ...
        <div class="col-md-9 col-lg-10 main-content p-0">
            ...
            <div class="p-4">
                ...
                <div class="mb-5 section-divider">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/admin/san-pham?action=update" method="post">
    ...
    <div class="modal fade" id="addModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="${pageContext.request.contextPath}/admin/san-pham?action=create" method="post">
                    <!-- ẩn ID vì thêm mới -->
                    ...
                    <a href="${pageContext.request.contextPath}/admin/san-pham" class="btn btn-secondary">
