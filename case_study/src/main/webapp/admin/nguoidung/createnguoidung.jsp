        ...
        <div class="col-md-9 col-lg-10 main-content p-0">
            ...
            <div class="p-4">
                ...
                <div class="mb-5 section-divider">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="/admin/nguoi-dung?action=add" method="post">
                                <c:if test="${nguoiDung != null}">
                                <input type="hidden" name="id" value="<c:out value='${nguoiDung.id}' />"/>
                                </c:if>
                                        ...
                                        <form action="/admin/nguoi-dung?action=add" method="post">
                                            <c:if test="${nguoiDung != null}">
                                                <input type="hidden" name="id"
                                                       value="<c:out value='${nguoiDung.id}' />"/>
                                            </c:if>
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label class="form-label fw-semibold">Tên *</label>
                                                    <input type="text" id="name" name="tenNguoiDung"
                                                           class="form-control"
                                                           placeholder="Nhập tên" value="${nguoiDung.tenNguoiDung}">
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label fw-semibold">Số điện thoại *</label>
                                                    <input type="text" id="name" name="sdt" class="form-control"
                                                           placeholder="Nhập số điện thoại" value="${nguoiDung.sdt}">
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="name" name="diaChi" class="form-control"
                                                           placeholder="Nhập địa chỉ" value="${nguoiDung.diaChi}">
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label fw-semibold">Mật Khẩu *</label>
                                                    <input type="text" id="name" name="matKhau" class="form-control"
                                                           placeholder="Nhập mật khẩu" value="${nguoiDung.matKhau}">
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label fw-semibold">Chức vụ *</label>
                                                    <select id="chucVu" name="idChucVu" class="form-select">
                                                        <c:forEach var="cv" items="${chucVuList}" varStatus="status">
                                                            <option value="${cv.id}">${cv.tenChuVu}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="d-flex justify-content-end gap-2">
                                                <a type="button" class="btn btn-secondary" href="/admin/nguoi-dung">
