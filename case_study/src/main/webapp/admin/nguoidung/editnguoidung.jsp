        ...
        <div class="col-md-9 col-lg-10 main-content p-0">
            ...
            <div class="p-4">
                ...
                <div class="mb-5 section-divider">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="/admin/nguoi-dung?action=edit" method="post">
                                        ...
                                        <form action="/admin/nguoi-dung?action=edit" method="post">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="name" name="tenNguoiDung" class="form-control"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select id="chucVu" name="idChucVu" class="form-select">
                                                        <c:forEach var="cv" items="${chucVuList}" varStatus="status">
                                                            <option value="${cv.id}" ${cv.id ==nguoiDung.idChucVu.id?'selected':''}>${cv.tenChuVu}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
