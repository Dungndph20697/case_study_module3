    ...
    <div class="col-md-9 col-lg-10 main-content p-0">
      ...
      <div class="p-4">
        ...
        <div class="mb-5 section-divider">
          ...
          <div class="card">
            <div class="card-body">
              <form action="/admin/chuc-vu?action=edit" method="post">
                <c:if test="${chucVu != null}">
                  <input type="hidden" name="id" value="<c:out value='${chucVu.id}' />"/>
                </c:if>
                <div class="modal-body">

                  <div class="mb-3">
                    <label class="form-label fw-semibold">Tên *</label>
                    <input type="text" id="name" name="tenChucVu" class="form-control"
                           placeholder="Nhập tên" value="${chucVu.tenChuVu}">
                  </div>
                </div>
                <div class="d-flex justify-content-end gap-2">
                  <a type="button" class="btn btn-secondary" href="/admin/chuc-vu">
